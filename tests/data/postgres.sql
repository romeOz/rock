/**
 * This is the database schema for testing PostgreSQL support of Rock Active Record.
 * To test this feature, you need to create a database named 'rocktest' on 'localhost'
