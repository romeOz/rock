...
use rock\validation\rules\Alpha;
use rock\validation\rules\Each;
use rock\validation\rules\Int;
use rock\validation\rules\NotEmpty;
use rock\validation\rules\String;
...
class EachTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException \rock\validation\exceptions\EachException
     */
