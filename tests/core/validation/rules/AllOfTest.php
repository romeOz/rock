...
use rock\validation\rules\Positive;
...
class AllOfTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @expectedException \rock\validation\exceptions\AllOfException
     */
    ...
    /**
     * @dataProvider providerStaticDummyRules
     * @expectedException \rock\validation\exceptions\CallbackException
     */
