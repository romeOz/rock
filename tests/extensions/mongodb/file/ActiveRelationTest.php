...
use rockunit\extensions\mongodb\models\file\CustomerFile;
...
class ActiveRelationTest extends MongoDbTestCase
{
    ...
    {
        parent::setUp();
        \rockunit\extensions\mongodb\models\ActiveRecord::$connection = $this->getConnection();
        \rockunit\extensions\mongodb\models\file\ActiveRecord::$connection = $this->getConnection();
        $this->setUpTestRows();
    }
