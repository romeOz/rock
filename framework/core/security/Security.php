 ...
 *
 * - Encryption/decryption: {@see \rock\security\Security::encrypt()} and {@see \rock\security\Security::decrypt()}
 ...
 *
 * Additionally, Security provides {@see \rock\security\Security::getSecretKey()} to support generating
...
class Security implements ComponentsInterface
{
    ...
    /**
     * @var string the path or alias of a file that stores the secret keys automatically generated by {@see \rock\security\Security::getSecretKey()}.
     ...
     * 
     * If the secret key does not exist, it will be automatically generated and saved in {@see \rock\security\Security::$secretKeyFile}.
    ...
    {
        $keyFile = Rock::getAlias($this->secretKeyFile);
