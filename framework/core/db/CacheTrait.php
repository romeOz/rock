...
trait CacheTrait
{
     ...
     * with query caching: [[queryCacheExpire]] and [[queryCacheTags]].
     *
     * @param int|null $expire
     * @param string[] $tags the dependency for the cached query result.
     * See [[queryCacheTags]] for more details.
     * If not set, it will use the value of [[queryCacheExpire]]. See [[queryCacheExpire]] for more details.
     * @return $this
     */
    ...
    protected function calculateCacheParams(Connection $connection)
    {
