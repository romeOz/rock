...
class Command
{
     ...
     */
    private function queryInternal($method, $fetchMode = null, $subAttributes = false)
    {
        $connection = $this->db;
        $rawSql = $this->getRawSql();
        $token = [
     ...
     * @param string $type the column type. [[\rock\db\QueryBuilder::getColumnType()]] will be called
