...
class Html
{
     ...
     * that are rendered by {@see \rock\template\Html::renderTagAttributes()}.
     */
     ...
     * - itemOptions: array, the options for generating the radio button tag using {@see \rock\template\Html::checkbox()}.
